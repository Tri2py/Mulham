...
jQuery(function ($) {
    ...
    function PortfolioModal() {
        ...
        const closeBtn = modal.querySelector('.bringer-modal-close');
        const overlay = modal.querySelector('.bringer-modal-overlay');

        // Open modal on portfolio item click
        document.querySelectorAll('[data-portfolio-item]').forEach(function (item) {
            item.style.cursor = 'pointer';
            item.addEventListener('click', function (e) {
                e.preventDefault();

                const dataEl = this.querySelector('.bringer-portfolio-data');
                if (!dataEl) return;

                const title = dataEl.querySelector('.portfolio-title')?.textContent || '';
                const category = dataEl.querySelector('.portfolio-category')?.textContent || '';
                const description = dataEl.querySelector('.portfolio-description')?.textContent || '';
                const imageSrc = dataEl.querySelector('.portfolio-image')?.textContent || '';
    ...
    window.portfolioCategories = {
        'branding': {
            ...
            category: 'Branding',
            description: 'Complete brand identity design including logo, color palette, typography, and brand guidelines. A cohesive visual system that communicates the brand\'s values and resonates with the target audience.'
        },
        'social-media': {
            title: 'Social Media Design',
            category: 'Social Media',
            description: 'Creative social media graphics and content design that engages audiences and builds brand presence. Includes post templates, story designs, and campaign visuals optimized for various platforms.'
        },
        'logo-design': {
            title: 'Visual Identity System',
            category: 'Logo Design',
            description: 'Custom logo design and visual identity system creation. From concept development to final delivery, including multiple variations, color specifications, and usage guidelines.'
        },
        'web-development': {
            title: 'E-commerce Platform',
            category: 'Web Development',
            description: 'Full-featured e-commerce platform with product catalog, shopping cart, secure checkout, and admin dashboard. Built with modern technologies for optimal performance and scalability.'
        },
        'full-stack': {
            title: 'Web Application',
            category: 'Full Stack Development',
            description: 'Custom web application development with user authentication, database integration, and responsive design. Features include real-time updates, data visualization, and API integrations.'
        },
        'frontend': {
            title: 'Landing Page',
            category: 'Frontend Development',
            description: 'High-converting landing page with smooth animations, optimized performance, and responsive design. Built with modern CSS and JavaScript for fast loading and excellent user experience.'
        }
    };
});
